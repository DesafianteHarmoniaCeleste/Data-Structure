...
/*
    ...
    essa funcao eh de extrema importancia para todo o codigo, sendo utilizado em varios contextos e circunstancias distintas
*/
...
void adicionarAresta(Grafo* grafo, Dinossauro origem, Dinossauro destino, int pos_ins){
    ...
    // enquanro posicao atual nao chega em nulo (indicando fim do grado) e ele nao esteja em ordem alfabetica
...
void insere_grafo(Grafo* grafo, Dados dino_lido){
    ...
    adicionarAresta(grafo, dino_lido_grafo, presa, posicao_inserida);
